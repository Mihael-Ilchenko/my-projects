...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/functions.js */ \"./src/js/modules/functions.js\");\n\n\nwindow.addEventListener(\"DOMContentLoaded\", () => {\n  _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.isWebp();\n\n  _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.tlContentLoaded.play();\n\n  _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.map();\n\n  _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.contacts();\n\n  _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.search();\n\n  _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.burgerMenu();\n\n  _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.scroll();\n\n  _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.validateStudio();\n  _modules_functions_js__WEBPACK_IMPORTED_MODULE_0__.validateContacts();\n});\n\n\n//# sourceURL=webpack://gulp/./src/js/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"burgerMenu\": () => (/* binding */ burgerMenu),\n/* harmony export */   \"contacts\": () => (/* binding */ contacts),\n/* harmony export */   \"isWebp\": () => (/* binding */ isWebp),\n/* harmony export */   \"map\": () => (/* binding */ map),\n/* harmony export */   \"scroll\": () => (/* binding */ scroll),\n/* harmony export */   \"search\": () => (/* binding */ search),\n/* harmony export */   \"tlContentLoaded\": () => (/* binding */ tlContentLoaded),\n/* harmony export */   \"validateContacts\": () => (/* binding */ validateContacts),\n/* harmony export */   \"validateStudio\": () => (/* binding */ validateStudio)\n/* harmony export */ });\n/* harmony import */ var just_validate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! just-validate */ \"./node_modules/just-validate/dist/just-validate.es.js\");\n// import gsap from \"gsap\";\n\n\ngsap.config({\n  nullTargetWarn: false,\n  trialWarn: false,\n});\n\n const search = () => {\n   const buttonSearchOpen = document.querySelector(\".search__open\");\n   const buttonSearchClose = document.querySelector(\".search__btn-close\");\n   const buttonSearch = document.querySelector(\".search__btn-search\");\n   const searchForm = document.querySelector(\".search__form\");\n   const searchInput = document.querySelector(\".search__input\");\n\n\n    const tl = gsap.timeline({ paused: true });\n    tl\n      .to('.search__open', { opacity: 0, x: -200, duration: 0.2, ease: 'expo'  })\n      .fromTo('.search__form', { display: 'none', scale: 0, x: 200, y: -200 }, { display: 'flex', scale: 1, x: 0, y: 0, ease: 'expo', duration: .5 })\n      .from('.search__btn-close', { x: -200, opacity: 0, rotate: 460, ease: 'expo', duration: 0.6, })\n      .from('.search__input', { opacity: 0, x: -200, duration: .5, ease: 'expo'})\n  \n   searchForm.addEventListener(\"submit\", (e) => {\n     e.preventDefault();\n      tl.reverse()\n   });\n\n\n   buttonSearchOpen.addEventListener(\"click\", function () {\n      tl.play()\n   });\n\n   buttonSearchClose.addEventListener('click', () => {\n     tl.reverse();\n   })\n\n   document.addEventListener(\"click\", (even) => {\n       if (even.target !== buttonSearchOpen && even.target !== searchInput) {\n          tl.reverse();\n          gsap.to('.search__btn-search', { x: 100, opacity: 0 })\n          gsap.to('.search__btn-close', { display: 'block'}, '+=0')\n          searchInput.value = \"\";\n       }\n   });\n\n   searchInput.addEventListener(\"input\", () => {\n     if (searchInput.value.trim() !== \"\") {\n      gsap.to('.search__btn-close', { display: 'none', x: 50, opacity: 0 })\n       gsap.to('.search__btn-search', { display: 'block', x: 0, opacity: 1 }, \"+=0\")\n     } else {\n       gsap.to('.search__btn-search', { display: 'none', x: -50, opacity: 0 })\n       gsap.to('.search__btn-close', { display: 'block', x: 0, opacity: 1 }, \"+=0\")\n     }\n   });\n };\n\nconst isWebp = () => {\n  function testWebp(callback) {\n    let webP = new Image();\n    webP.onload = webP.onerror = function() {\n      callback(webP.height == 2);\n    };\n      webP.src = 'data:image/webp;base64,UklGRjoAAABXRUJQVlA4IC4AAACyAgCdASoCAAIALmk0mk0iIiIiIgBoSygABc6WWgAA/veff/0PP8bA//LwYAAA';\n  }\n\n  testWebp(function(support) {\n    let className = support === true ? 'webp' : 'no-webp';\n    document.documentElement.classList.add(className)\n  })\n}\n\n\n  const burgerMenu = () => {\n   const buttonBurger = document.querySelector(\".header-bottom__btn\");\n   const navList = document.querySelector(\".header-bottom__list\");\n   const items = Array.from(document.querySelectorAll(\".header-bottom__item\"));\n   const burgerDrop = document.querySelector('.header-bottom__dropdown');\n   const tlBurger = gsap.timeline({ paused: true });\n     tlBurger\n         .to('.btn-line',{ opacity: 0 })\n         .fromTo('.header-bottom__dropdown', {},{ position: 'absolute', top: 0, right: 0, left: 0, paddingTop: 48,\n          paddingBottom: 36, background: '#202020'})\n\n         .fromTo(\".header-bottom__btn\", {  }, {position: 'absolute', top: 15, left: 21})\n         .fromTo('.header-bottom__list', { }, { display: 'flex', opacity: 1})\n          .fromTo(\".header-bottom__btn > svg\" ,{ display: \"none\", opacity: 0}, {display: 'block', opacity: 1})\n\n\n   buttonBurger.addEventListener(\"click\", () => {  \n     if(!burgerDrop.classList.contains('header-bottom__dropdown--active')) {\n      burgerDrop.classList.add('header-bottom__dropdown--active');\n        document.body.classList.add('overflow-y-no')\n        tlBurger.play();    \n      } else {\n        tlBurger.reverse();\n      burgerDrop.classList.remove('header-bottom__dropdown--active');\n        document.body.classList.remove('overflow-y-no')\n     }\n    })\n     document.addEventListener(\"click\", (even) => {\n       if (even.target !== navList && even.target !== buttonBurger) {\n          tlBurger.reverse();\n        burgerDrop.classList.remove('header-bottom__dropdown--active');\n          document.body.classList.remove('overflow-y-no')\n       }\n     });   \n\n\n     items.forEach((item) => {\n      item.addEventListener(\"click\", () => {\n         tlBurger.reverse();\n       burgerDrop.classList.remove('header-bottom__dropdown--active');\n         document.body.classList.remove('overflow-y-no')\n      });\n    })\n };\n\n\nconst scroll = () => {\n  const breakpoint = 0; //<===\n  function getWindowWidth() {\n    return Math.max(\n      document.body.scrollWidth,\n      document.documentElement.scrollWidth,\n      document.body.offsetWidth,\n      document.documentElement.offsetWidth,\n      document.body.clientWidth,\n      document.documentElement.clientWidth\n    );\n  }\n  function scrollToContent(link, isMobile) {\n    if (isMobile && getWindowWidth() > breakpoint) {\n      return;\n    }\n    const href = link.getAttribute(\"href\").substring(1);\n    const scrollTarget = document.getElementById(href);\n    const elementPosition = scrollTarget.getBoundingClientRect().top;\n\n    window.scrollBy({\n      top: elementPosition,\n      behavior: \"smooth\",\n    });\n  }\n  document.querySelectorAll(\".scroll\").forEach((link) => {\n    link.addEventListener(\"click\", function (e) {\n      e.preventDefault();\n      scrollToContent(this, false); //<===\n    });\n  });\n};\n\nconst map = () => {\n  ymaps.ready(init);\n  function init() {\n    var myMap = new ymaps.Map(\n      \"map\",\n      {\n        center: [55.76744001311972, 37.6290032],\n        zoom: 15,\n        controls: [],\n      },\n      {\n        suppressMapOpenBlock: true,\n        geolocationControlFloat: \"none\",\n      }\n    );\n    myMap.behaviors.disable([\"scrollZoom\"]);\n    var myGeoObject = new ymaps.GeoObject({\n      geometry: {\n        type: \"Point\",\n        //  coordinates: [55.770233, 37.636787]\n      },\n    });\n    var myPlacemark = new ymaps.Placemark(\n      [55.770233, 37.636787],\n      {},\n      {\n        iconLayout: \"default#image\",\n        iconImageHref: \"../img/icon-map.png\",\n        iconImageSize: [12, 12],\n        iconImageOffset: [0, -20],\n      }\n    );\n    myMap.geoObjects.add(myGeoObject);\n    myMap.geoObjects.add(myPlacemark);\n  }\n};\n\nconst contacts = () => {\n  const btnClose = document.querySelector('.address-btn');\n  const btnOpen = document.querySelector('.address-open');\n\n  const address = document.querySelector(\".contacts__address\");\n\n  btnClose.addEventListener(\"click\", () => {\n    gsap.to(address, {opacity: 0,x: 300, y: 600, rotate: -90})\n    gsap.to(btnOpen, {opacity: 1})\n  });\n\n  btnOpen.addEventListener('click', () => {\n    gsap.to(address, {opacity: 1, x: 0, y: 0, rotate: 0})\n    gsap.to(btnOpen, {opacity: 0})\n  })\n};\n\nconst validateStudio = () => {\n  const form = document.querySelector('.studio-right__form');\n  const input = document.querySelector('.studio-right__input');\n  const checkEmail = /[^a-zA-Z|@|.]+$/g;\n\n  const validation = new just_validate__WEBPACK_IMPORTED_MODULE_0__[\"default\"](document.querySelector('.studio-right__form'))\n\n  validation.addField('.validate-email', [\n   {\n     rule: 'required',\n     errorMessage: 'Поле обязательно для заполнения',\n   },\n   {\n     rule: 'email',\n     errorMessage: 'Email должен быть в формате ivanov@mail.com',\n   },\n ])\n \n}\n\n\nconst validateContacts = () => {\n  const validation = new just_validate__WEBPACK_IMPORTED_MODULE_0__[\"default\"](document.querySelector('.contacts__form'))\n\n  validation\n  .addField('.contacts-name', [\n    {\n      rule: 'required',\n      errorMessage: 'Поле обязательно для заполнения',\n    },\n    {\n      rule: 'minLength',\n      value: 3,\n      errorMessage: 'Значение должно быть минимум 3',\n    },\n    {\n      rule: 'maxLength',\n      value: 30,\n      errorMessage: 'Значений должно быть ммаксимум 30',\n    },\n  ])\n  .addField('.contacts-email', [\n   {\n     rule: 'required',\n     errorMessage: 'Поле обязательно для заполнения',\n   },\n   {\n     rule: 'email',\n     errorMessage: 'Email должен быть в формате ivanov@mail.com',\n   },\n ])\n \n}\n  const tlContentLoaded = \n  gsap.timeline({ paused: true });\n  tlContentLoaded\n                  .from(document.querySelector('.header'), { opacity: 0, y: -1000, ease: 'expo', duration: .4})\n                  .from(document.querySelector('.header-logo'), { opacity: 0, y: 1000, ease: 'expo', duration: .3})\n                  .from('.nav', { opacity: 0, scale: 0, y: 1000, ease: 'expo', duration: .3})\n                  .from('.search', { opacity: 0, y: 1000, ease: 'expo', duration: .3})\n\n                  .from('.photoset', { opacity: 0, scale: 0, rotate: 90, ease: 'expo'})\n                  .from('.master-class', { opacity: 0, y: 500, rotate: 90,  ease: 'expo'})\n                  .from('.three-img', { opacity: 0, y: 500, rotate: 90,  ease: 'expo'})\n                  .from('.hero-text', { opacity: 0, y: -500,  ease: 'bounce', duration: 1.6})\n\n//# sourceURL=webpack://gulp/./src/js/modules/functions.js?");
